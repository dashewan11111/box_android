...
package com.box.zxing.decoding;
...
import com.box.zxing.view.ViewfinderResultPointCallback;
...
public final class CaptureActivityHandler extends Handler {
	...
	public void handleMessage(Message message) {
		...
		case R.id.auto_focus:
			// Log.e(TAG, "Got auto-focus message");
		...
		case R.id.decode_succeeded:
			...
			activity.handleDecode((Result) message.obj, null);// ���ؽ��?
																// /***********************************************************************/
			break;
